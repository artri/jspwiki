...
public class BreadcrumbsTag extends WikiTagBase {
    ...
    private static final WikiLogger log = WikiLogger.getLogger(BreadcrumbsTag.class);
    ...
    public int doWikiStartTag() throws IOException {
        ...
        // FIXME: this code would be much simpler if we could just output the [pagename]
        // and then use the
