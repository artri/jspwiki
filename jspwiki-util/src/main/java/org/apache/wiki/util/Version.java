...
public final class Version implements Comparable<Version>, Serializable {
    ...
    private static Version parse(String s, boolean verifyOnly) {
        ...
        final char[] stream = s.trim().toCharArray();
        int major = 0;
        int minor = 0;
        int patch = 0;
    ...
    public boolean isGreaterThanOrEqualTo(String other) {
        require(StringUtils.isNotBlank(other), "other must no be empty");
        return isGreaterThanOrEqualTo(Version.parseVersion(other, true));
    }
    ...
    public boolean isLowerThanOrEqualTo(String other) {
        require(StringUtils.isNotBlank(other), "other must no be empty");
        return isLowerThanOrEqualTo(Version.parseVersion(other, true));
    }
