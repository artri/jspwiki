 ...
 * </ol>
 * </code> There are also a couple of convenience methods for unit testing:
 * <code>
 * <ol>
 *   <li>hsqldbu.setUp()</li>
...
public class HsqlDbUtils {
    ...
    private static final WikiLogger LOG = WikiLogger.getLogger(HsqlDbUtils.class);
    ...
    Connection getConnection() throws IOException, SQLException {
        ...
        return DriverManager.getConnection(getDriverUrl(), jProps.getProperty("jdbc.admin.id"),
