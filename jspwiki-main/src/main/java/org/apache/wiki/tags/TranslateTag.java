...
public class TranslateTag extends BodyTagSupport {
    ...
    private static final long serialVersionUID = 3004817712991579680L;
    private static final WikiLogger log = WikiLogger.getLogger(TranslateTag.class);
    ...
    public final int doAfterBody() throws JspException {
        try {
            ...
            // Because the TranslateTag should not affect any of the real page attributes we
